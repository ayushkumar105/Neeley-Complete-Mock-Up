        ...
        <div class="col">
          ...
          <div style="margin-left:4rem;margin-right: 4rem;">
            ...
            <p style="margin-top:1rem;color:#4d4d4a;font-size:large">
              Research happens at universities across disciplines, including at the TCU Neeley School of Business. Research is developed under the direction of a faculty mentor that culminates in a formal presentation or publication. Students may present their research at a Neeley-hosted showcase, at a TCU-hosted showcase, or through a department’s showcase.
            </p>
            <p style="margin-top:1rem;color:#4d4d4a;font-size:large;">
            ...
            <ul style="list-style-type:circle;color:#4d4d4a;d4a;font-size:large">
              <li>Apply research methods appropriate for the student's discipline</li>
              <li>Engage in ongoing critical discussion within their chosen field</li>
            </ul>
            </p>
            ...
            <div class="accordion-item">
              ...
              <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                <div class="accordion-body">
                  <ul style="list-style-type:circle;color:#4d4d4a;d4a;font-size:large">
                    <li>Research under faculty supervision for a minimum of one semester.</li>
                    <li>Verification documentation submitted by the Faculty mentor of the research project.</li>
                                    
                  </ul>
                  <a href="#" style="color:#4c0c95;font-weight:bold;font-size: larger;font-style: italic;">RUBRIC FOR RESEARCH</a>      
                </div>
              </div>
            </div>
            <div class="accordion-item">
              ...
              <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                <div class="accordion-body">
                  <ul style="list-style-type:circle;color:#4d4d4a;d4a;font-size:large">
                    <li>
                      <a href="https://www.neeley.tcu.edu/Page/Research/91a0d76e-eebd-46c2-8971-6097ef396ac6" style="color:#4c0c95;font-weight:bold">Neeley Analytics Initiative Research</a>
                    </li>
