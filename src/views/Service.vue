        ...
        <div class="col">
          ...
          <div style="margin-left:4rem;margin-right: 4rem;">
            ...
            <p style="margin-top:1rem;color:#4d4d4a;font-size:large">
               Service is not about checking a box on your resume or helping someone or something for an afternoon. Service is about contributing to your community, the place you exist, the place you rely on. When the least fortunate can become more fortunate, society thrives, and by investing your own effort into your community’s people, built environment, resources, and health, you can grow greater appreciation for and have more gratitude for the place you call home. 
            </p>
              ...
              <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                <div class="accordion-body">
                  <ul style="list-style-type:circle;color:#4d4d4a;d4a;font-size:large">
                    <li>This service must be done in your own city, town, or county.</li>
            ...
            <div class="accordion-item">
              ...
              <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                <div class="accordion-body">
                  <ul style="list-style-type:circle;color:#4d4d4a;d4a;font-size:large">
                    <li>
                      <a href="https://engage.tcu.edu/organization/communityengagement" style="color:#4c0c95;font-weight:bold">TCU Community Engagement Organization</a>
                    </li>
                    <li>
                      <a href="https://engage.tcu.edu/organization/dayofservice" style="color:#4c0c95;font-weight:bold">TCU Day of Service Organization</a>
                    </li>
                    <li>
                      <a href="https://www.fortworthtexas.gov/volunteer" style="color:#4c0c95;font-weight:bold">Fort Worth Volunteer Opportunities</a>      
                    </li>
