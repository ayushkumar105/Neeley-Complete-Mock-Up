    ...
    <div class="container">
        <div class="row justify-content-md-center">
            <div class="col">
                <nav style="--bs-breadcrumb-divider: '>';margin-left:2rem;" aria-label="breadcrumb" >
                    ...
                    <li class="breadcrumb-item active" aria-current="page" style="color:#4c0c95; font-weight: bold;">Join</li>
                    </ol>
                </nav>  
        <div class="steps">
        <h1 style="color:#4c0c95; margin-top: 0;">HOW IT WORKS</h1>
        ...
        <div class="col-md-auto" style="background-color:#c7c6c3; margin-left: 0;">
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical" style="margin-top:2rem">
                ...
                <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false" style="background-color:#c7c6c3; color:#4d4d4a">
