        ...
        <div class="col">
          <nav style="--bs-breadcrumb-divider: '>';margin-left:2rem;" aria-label="breadcrumb" >
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page" style="color:#4c0c95; font-weight: bold;">Intercultural Education</li>
            </ol>
          </nav>  
          <div style="margin-left:4rem;margin-right: 4rem;">
            ...
            <ul style="list-style-type:circle;color:#4d4d4a;d4a;font-size:large">
              <li>Convey attitudes of respect, openness, curiosity and discovery towards a culture different from their own</li>
              <li>Identify and interpret cultural differences</li>
              <li>Adjust their behavior and/or language, based on intercultural situations</li>
              <li>Collaborate effectively with people from cultures different from their own</li>
              <li>Recognize that their worldview is not universal.</li>
            </ul>
            </p>
